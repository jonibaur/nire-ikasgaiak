...
Sare informatikoak ordenagailuak eta gailuak konektatzeko sistemak dira, datuak partekatzeko eta zerbitzuak eskaintzeko. Sareek hainbat topologia eta teknologia erabiltzen dituzte.

  

### Sare motak:

- **LAN (Local Area Network):** Sare lokalak, adibidez, bulego edo ikastetxe batean.

- **MAN (Metropolitan Area Network):** Hiri mailako sareak.

- **WAN (Wide Area Network):** Sare zabalak, adibidez, Internet.

  

### Topologiak:

- Bus, eraztun, izar, hibrido
...
- IPv4: 32 bit, adibidez: 192.168.1.1

- IPv6: 128 bit, adibidez: 2001:0db8:85a3::8a2e:0370:7334
...
- Maskarak: sarearen tamaina definitzen dute

  

### DHCP

- IP helbideak automatikoki esleitzen ditu

  

### DNS

- Izenak IP bihurtzen ditu (adib. www.ejemplo.com → 192.168.1.10)
...
## 3. Oinarrizko Sare Zerbitzuak

  

### DHCP

- Zerbitzariak IP helbideak banatzen ditu

  

### DNS

- Domeinu izenak IP bihurtzen ditu

  

### HTTP/HTTPS

- Web zerbitzuak eskaintzen dituzte

  

### FTP/SFTP

- Fitxategiak transferitzeko protokoloak

  

### SMTP/IMAP/POP3

- Posta elektronikoaren zerbitzuak
...
## 4. Sareko Tresnak eta Diagnostikoa

  

### Komando erabilgarriak:

- `ping`: konektagarritasuna egiaztatzeko

- `traceroute`: bidearen urratsak ikusteko

- `nslookup`, `dig`: DNS kontsultak

- `ipconfig` / `ifconfig`: IP konfigurazioa

- `netstat`: konexio aktiboak

- **Wireshark**: sareko trafikoa aztertzeko tresna
...
## 5. Segurtasunaren Oinarriak

  

### Arriskuak:

- Sniffing, spoofing, DoS
...
---
## 03.2 Zerbitzari motak eta eginkizunak
